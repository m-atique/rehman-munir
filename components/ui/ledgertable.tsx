...
export function DataTablewithFilters<TData, TValue>({
  ...
  return (
    ...
    <div className="rounded-md border ">
      ...
      <Table>
        <TableHeader className="bg-slate-200 text-black hover:bg-slate-200 hover: ">
          {table.getHeaderGroups().map((headerGroup) => (
            <TableRow key={headerGroup.id}>
              {headerGroup.headers.map((header) => {
                return (
                  <TableHead key={header.id} className="text-black border-2 border-slate-900 text-center  ">
